...
async def run_test():
    ...
    try:
        ...
        # Click on 'Continue with Google' button to start Google OAuth flow
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/div/div[2]/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input the email 'test123@gmail.com' into the email field and proceed
        frame = context.pages[-1]
